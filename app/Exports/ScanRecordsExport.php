...
class ScanRecordsExport implements FromQuery, WithHeadings, WithMapping
{
    ...
    public function query(): Builder
    {
        ...
        */
        ...
        if (!empty($this->allowedOutletIds)) {
            $query->whereIn('outlet_id', $this->allowedOutletIds);
        }
        ...
        */
        ...
        if ($this->outletType !== null && $this->outletType !== '') {
            $query->whereHas('outlet', function (Builder $outletQuery) {
                $outletQuery->where('outlet_type', $this->outletType);
            });
        }
